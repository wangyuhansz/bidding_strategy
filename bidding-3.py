...
def bid(player_name, bidding_points, object_name):
    '''A player bids some points for an object.'''
...
def All_In(player_name):
    '''Players bid all the points to the very object they want most.'''
...
def Spread_Out(player_name):
    '''Players bid only one point to every object.'''
...
# "Linear_Allocation" strategy: Allocate the points linearly
def Linear_Allocation(player_name):
    '''Players allocate the points linearly to the most-wanted objects.'''
...
def Exponential_Allocation(player_name):
    '''Players allocate the points exponentially to the most-wanted objects.'''
